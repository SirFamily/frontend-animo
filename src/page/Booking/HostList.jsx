...
export default function HostList() {
  ...
  {isData.map((host) => (
    <div key={host.id} onClick={() => togglePopup(host)} class="bg-white p-4 rounded-lg shadow-md mt-4 mb-4">
      <h2>{host.hostName}</h2>
...
{isPopupOpen && <HostDetailForBooking onClose={togglePopup} selectedHost={selectedHost}/>}
    </>
  )
}
